...
8. Open and execute 01_format_the_curated_file.R (you need to open the script and change file names etc and execute it line by line). It should generate the final table -
20250512_ouput_curation_formated.tsv