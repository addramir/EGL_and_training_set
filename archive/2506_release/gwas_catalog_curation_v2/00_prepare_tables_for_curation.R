...
library(data.table)
gwascat=fread("gwas-catalog-v1.0.3.1-studies-r2025-06-10.tsv",data.table=FALSE,quote="")
...
old_cur=fread("20250512_output_curation.txt",data.table=FALSE,quote="")
...
fwrite(x=x,file="20250612_input_for_curation.tsv",sep="\t",quote=FALSE)
